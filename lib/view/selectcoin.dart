...
import 'package:crypto_ui/models/chartmodel.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;
import 'package:syncfusion_flutter_charts/charts.dart';
//import '../Model/chartModel.dart';

class SelectCoinone extends StatefulWidget {
  var selectItem;

  SelectCoinone({this.selectItem});

  @override
  State<SelectCoinone> createState() => _SelectCoinoneState();
}

class _SelectCoinoneState extends State<SelectCoinone> {
